...
export const metadata: Metadata = {
  title: "Switchboard — BrightSmile Dental Group",
  description:
    "Real-time AI voice agent command console: live calls, streaming transcripts, sentiment, supervisor controls, QA scoring.",
};
